    ...
    <>
      ...
      <Routes>
        <Route element={<Layout />}>
          ...
          <Route path="/about" element={<StaticHtmlPage filename="about.html" />} />
          <Route path="/team" element={<StaticHtmlPage filename="team.html" />} />
          <Route path="/gallery" element={<StaticHtmlPage filename="Gallery.html" />} />
          <Route path="/verticals" element={<StaticHtmlPage filename="Verticals.html" />} />
          <Route
            path="/accolades"
            element={<StaticHtmlPage filename="Achievements and recognitions.html" />}
          />
